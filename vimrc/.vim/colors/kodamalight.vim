...
if &t_Co > 255
  highlight Normal          ctermfg=024     ctermbg=195     cterm=none
  highlight SpecialKey      ctermfg=017     ctermbg=none    cterm=none
  highlight NonText         ctermfg=017     ctermbg=none    cterm=none
  highlight Directory       ctermfg=210     ctermbg=none    cterm=none
  highlight ErrorMsg        ctermfg=205     ctermbg=none    cterm=bold
  highlight IncSearch       ctermfg=0       ctermbg=63      cterm=none
  highlight Search          ctermfg=63      ctermbg=none    cterm=bold
  highlight MoreMsg         ctermfg=034     ctermbg=none    cterm=bold
  highlight ModeMsg         ctermfg=233     ctermbg=none    cterm=bold
  highlight LineNr          ctermfg=197     ctermbg=159     cterm=none
  highlight CursorLineNr    ctermfg=none     ctermbg=194       cterm=bold
  highlight Question        ctermfg=63      ctermbg=none    cterm=bold
  highlight StatusLine      ctermfg=233     ctermbg=0       cterm=bold
  highlight StatusLineNC    ctermfg=248     ctermbg=0       cterm=none
  highlight VertSplit       ctermfg=0       ctermbg=0       cterm=none
  highlight Title           ctermfg=233     ctermbg=none    cterm=none
  highlight Visual          ctermfg=0       ctermbg=244     cterm=none
  highlight VisualNOS       ctermfg=233     ctermbg=none    cterm=underline
  highlight WarningMsg      ctermfg=196     ctermbg=220    cterm=bold
  highlight WildMenu        ctermfg=0       ctermbg=63      cterm=none
  ...
  highlight SpellBad        ctermfg=205     ctermbg=none    cterm=underline
  highlight SpellCap        ctermfg=63      ctermbg=none    cterm=underline
  highlight SpellRare       ctermfg=034     ctermbg=none    cterm=underline
  highlight SpellLocal      ctermfg=228     ctermbg=none    cterm=underline
  highlight Pmenu           ctermfg=251     ctermbg=0       cterm=none
  highlight PmenuSel        ctermfg=0       ctermbg=017     cterm=none
  highlight PmenuSbar       ctermfg=206     ctermbg=235     cterm=none
  highlight PmenuThumb      ctermfg=235     ctermbg=206     cterm=none
  highlight TabLine         ctermfg=248     ctermbg=0       cterm=none
  highlight TablineSel      ctermfg=0       ctermbg=017     cterm=none
  highlight TablineFill     ctermfg=248     ctermbg=0       cterm=none
  highlight CursorColumn    ctermfg=none    ctermbg=194     cterm=none
  highlight CursorLine      ctermfg=none    ctermbg=194     cterm=none
  highlight ColorColumn     ctermfg=none    ctermbg=194     cterm=none
  highlight Cursor          ctermfg=0       ctermbg=233     cterm=none
  highlight MatchParen      ctermfg=235     ctermbg=214     cterm=bold
  highlight Comment         ctermfg=017     ctermbg=none    cterm=bold,italic
  ...
  highlight Statement       ctermfg=017     ctermbg=none    cterm=none
  highlight PreProc         ctermfg=022     ctermbg=none    cterm=italic
  highlight Type            ctermfg=141     ctermbg=none    cterm=bold
  highlight Underlined      ctermfg=017     ctermbg=none    cterm=underline
  highlight Error           ctermfg=205     ctermbg=none    cterm=none
  highlight Todo            ctermfg=63      ctermbg=none    cterm=bold
  highlight String          ctermfg=166     ctermbg=none    cterm=italic
  highlight Number          ctermfg=022     ctermbg=none    cterm=none
  highlight Function        ctermfg=114     ctermbg=none    cterm=none
  highlight Keyword         ctermfg=205     ctermbg=none    cterm=bold
end
